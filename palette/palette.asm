...
;║   (__)           ╙─╜╙─╜ ╨ ╨╙─╜╟─╜╙─╜╙╙─╜╙─╜╙─╜╙─╜ Locker            ║
;║-- ( oo ---------------------- ╜ ------------------------------------║
;║   /\_|          by Dr.Chandra/HeuristiX, Feb-1994!                  ║
;║        Mini residente que mantiene una paleta arbitraria fija.      ║
;╙─────────────────────────────────────────────────────────────────────╜
...
_PaL_LoCK:     jmp      Start          ; Nos saltamos la parte que quedará...
...
;-----------------------------------------------------------------------------
; Parche a la INT 10 que dejará nuestra paleta FIJA! :)
;-----------------------------------------------------------------------------
...
NoCheck:
           ...
           call   dword ptr cs:Old_Int ; ...haga lo que tié que hacer!
...
Banner     db     "     The Cow-2-matic TextPalette Locker by Dr.Chandra/HeuristiX v0.9ß",13,10
...
;     Para comprobar si está instalado llamaremos a la int 10h con ciertos
