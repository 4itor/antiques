...
esc_brk         equ     10000001b       ; Código de Break de la tecla ESCAPE!
...
help       db     ' ',7,' ',7,' ',7,' ',7,' ',7,' ',7,'H',11,'e',3,'u',7
           ...
           db     7,'φ',8,' ',7,'<',8,'u',11,'p',3,'/',8,'d',11,'o',3,'w'
           db     7,'n',7,'/',8,'p',11,'g',3,'u',7,'p',7,'/',8,'p',11,'g'
           db     3,'d',7,'n',7,'>',8,' ',7,'φ',8,' ',7,'<',8,'e',11,'s'
           db     3,'c',7,'>',8,' ',7,'q',7,'u',7,'i',7,'t',7,' ',7,'φ'
